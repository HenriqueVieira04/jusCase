...
import type { KeyCreation, Config, IndexOptions, IndexObject, Key, Health, Stats, Version, KeyUpdate, IndexesQuery, IndexesResults, KeysQuery, KeysResults, IndexSwap, MultiSearchParams, FederatedMultiSearchParams, MultiSearchResponseOrSearchResponse, EnqueuedTask, EnqueuedTaskPromise, ExtraRequestInit, Network, RecordAny, RuntimeTogglableFeatures, ResourceResults, SearchRule, SearchRuleUpdatePayload, SearchRuleListPayload, Webhook, ResultsWrapper, WebhookCreatePayload, WebhookUpdatePayload, InitializeNetworkOptions, AddRemoteOptions, RemoveRemoteOptions, UpdateNetworkOptions, RenderTemplateParams, RenderTemplateResponse } from "./types/index.js";
...
export declare class Meilisearch {
     ...
     */
    updateDynamicSearchRule(uid: string, rule: SearchRuleUpdatePayload): EnqueuedTaskPromise;
    /**
     ...
     * @experimental
     */
    updateNetwork(options: UpdateNetworkOptions): Promise<EnqueuedTask | Network>;
    /**
